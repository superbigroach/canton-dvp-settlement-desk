...
public class AV_Party extends AnyValue {
  public static final String _packageId = "4ded6b668cb3b64f7a88a30874cd41c75829f5e064b3fbbadf41ec7e8363354f";

  public final String stringValue;

  public AV_Party(String stringValue) {
    this.stringValue = stringValue;
  }

  public Variant toValue() {
    return new Variant("AV_Party", new Party(this.stringValue));
  }
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof AV_Party)) {
      return false;
    }
    AV_Party other = (AV_Party) object;
  ...
  public String toString() {
    return String.format("AV_Party(%s)", this.stringValue);
  }

  @Override
  protected JsonLfEncoders.Field fieldForJsonEncoder() {
    return JsonLfEncoders.Field.of("AV_Party", apply(JsonLfEncoders::party, stringValue));
  }
}
