...
public class TransferInstruction_Accept extends DamlRecord<TransferInstruction_Accept> {
  ...
  public TransferInstruction_Accept(ExtraArgs extraArgs) {
    this.extraArgs = extraArgs;
  }

  public static ValueDecoder<TransferInstruction_Accept> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new TransferInstruction_Accept(extraArgs);
    } ;
  }
  ...
  public static JsonLfDecoder<TransferInstruction_Accept> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("extraArgs"), name -> {
        ...
        , (Object[] args) -> new TransferInstruction_Accept(JsonLfDecoders.cast(args[0])));
  }

  public static TransferInstruction_Accept fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof TransferInstruction_Accept)) {
      return false;
    }
    TransferInstruction_Accept other = (TransferInstruction_Accept) object;
  ...
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.transferinstructionv1.TransferInstruction_Accept(%s)",
        this.extraArgs);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<TransferInstruction_Accept> get() {
      return jsonDecoder();
    }
  }
}
