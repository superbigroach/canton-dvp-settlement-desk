...
public final class BasketReceipt extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("f10d37a10d40ff7923e1d7476f49347809a28a7803b3be0c4252b2417f921d12", "Basket", "BasketReceipt");
  ...
  public static final Choice<BasketReceipt, com.lucilla.settlement.model.da.internal.template.Archive, Unit> CHOICE_Archive = 
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, BasketReceipt> COMPANION = 
      new ContractCompanion.WithoutKey<>("com.lucilla.settlement.model.basket.BasketReceipt",
   ...
   */
  @Deprecated
  public static BasketReceipt fromValue(Value value$) throws IllegalArgumentException {
  ...
  public static class Contract extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, BasketReceipt> {
    public Contract(ContractId id, BasketReceipt data, Optional<String> agreementText,
