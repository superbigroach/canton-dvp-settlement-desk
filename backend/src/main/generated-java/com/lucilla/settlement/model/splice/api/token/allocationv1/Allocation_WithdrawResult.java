...
public class Allocation_WithdrawResult extends DamlRecord<Allocation_WithdrawResult> {
  ...
  public Allocation_WithdrawResult(List<Holding.ContractId> senderHoldingCids, Metadata meta) {
    this.senderHoldingCids = senderHoldingCids;
    this.meta = meta;
  }

  public static ValueDecoder<Allocation_WithdrawResult> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new Allocation_WithdrawResult(senderHoldingCids, meta);
    } ;
  }
  ...
  public static JsonLfDecoder<Allocation_WithdrawResult> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("senderHoldingCids", "meta"), name -> {
        ...
        , (Object[] args) -> new Allocation_WithdrawResult(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1])));
  }

  public static Allocation_WithdrawResult fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Allocation_WithdrawResult)) {
      return false;
    }
    Allocation_WithdrawResult other = (Allocation_WithdrawResult) object;
  ...
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.allocationv1.Allocation_WithdrawResult(%s, %s)",
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Allocation_WithdrawResult> get() {
      return jsonDecoder();
    }
  }
}
