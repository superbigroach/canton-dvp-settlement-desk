...
public class CloseSession extends DamlRecord<CloseSession> {
  public static final String _packageId = "16b1d7198cf7c7ec9373fe2d1bdb48ab1770fe7ffcb7281ad87048ebecd45ab4";

  public CloseSession() {
  }

  public static ValueDecoder<CloseSession> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<CloseSession> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new CloseSession());
  }

  public static CloseSession fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof CloseSession)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "com.lucilla.settlement.model.continuousbook.CloseSession";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<CloseSession> get() {
      return jsonDecoder();
    }
  }
}
