...
public class AllocationFactoryView extends DamlRecord<AllocationFactoryView> {
  ...
  public AllocationFactoryView(String admin, Metadata meta) {
    this.admin = admin;
    this.meta = meta;
  }

  public static ValueDecoder<AllocationFactoryView> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AllocationFactoryView(admin, meta);
    } ;
  }
  ...
  public static JsonLfDecoder<AllocationFactoryView> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("admin", "meta"), name -> {
          switch (name) {
        ...
        , (Object[] args) -> new AllocationFactoryView(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1])));
  }

  public static AllocationFactoryView fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof AllocationFactoryView)) {
      return false;
    }
    AllocationFactoryView other = (AllocationFactoryView) object;
    return Objects.equals(this.admin, other.admin) && Objects.equals(this.meta, other.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.admin, this.meta);
  }

  @Override
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.allocationinstructionv1.AllocationFactoryView(%s, %s)",
        this.admin, this.meta);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<AllocationFactoryView> get() {
      return jsonDecoder();
    }
  }
}
