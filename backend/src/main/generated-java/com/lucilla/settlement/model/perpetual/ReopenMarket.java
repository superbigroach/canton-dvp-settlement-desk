...
public class ReopenMarket extends DamlRecord<ReopenMarket> {
  ...
  public static ValueDecoder<ReopenMarket> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(0,0,
          recordValue$);
      return new ReopenMarket();
    } ;
  }
  ...
  public static JsonLfDecoder<ReopenMarket> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new ReopenMarket());
  }

  public static ReopenMarket fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof ReopenMarket)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "com.lucilla.settlement.model.perpetual.ReopenMarket";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<ReopenMarket> get() {
      return jsonDecoder();
    }
  }
}
