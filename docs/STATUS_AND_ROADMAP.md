...
| 17 | **Committee criteria modelled on TradFi** — intelligence docs on how ICE/LBMA, CME CF Benchmarks, WM/Refinitiv, S&P DJI, FTSE Russell, Platts and ETF sponsors/APs/transfer agents publish and govern (`BUSINESS/1-LEARN/11-…`, `12-…`), then a gap pass on the rulebook, benchmark statement and signer protocol per seat | nothing | in progress 24 Sep |
