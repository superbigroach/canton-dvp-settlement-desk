...
public class AllocationInstruction_Update extends DamlRecord<AllocationInstruction_Update> {
  ...
  public AllocationInstruction_Update(List<String> extraActors, ExtraArgs extraArgs) {
    this.extraActors = extraActors;
    this.extraArgs = extraArgs;
  }

  public static ValueDecoder<AllocationInstruction_Update> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new AllocationInstruction_Update(extraActors, extraArgs);
    } ;
  }
  ...
  public static JsonLfDecoder<AllocationInstruction_Update> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("extraActors", "extraArgs"), name -> {
        ...
        , (Object[] args) -> new AllocationInstruction_Update(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1])));
  }

  public static AllocationInstruction_Update fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof AllocationInstruction_Update)) {
      return false;
    }
    AllocationInstruction_Update other = (AllocationInstruction_Update) object;
  ...
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.allocationinstructionv1.AllocationInstruction_Update(%s, %s)",
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<AllocationInstruction_Update> get() {
      return jsonDecoder();
    }
  }
}
