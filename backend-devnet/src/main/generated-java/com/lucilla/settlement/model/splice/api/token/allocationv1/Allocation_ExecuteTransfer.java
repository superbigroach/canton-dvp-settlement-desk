...
public class Allocation_ExecuteTransfer extends DamlRecord<Allocation_ExecuteTransfer> {
  ...
  public Allocation_ExecuteTransfer(ExtraArgs extraArgs) {
    this.extraArgs = extraArgs;
  }

  public static ValueDecoder<Allocation_ExecuteTransfer> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new Allocation_ExecuteTransfer(extraArgs);
    } ;
  }
  ...
  public static JsonLfDecoder<Allocation_ExecuteTransfer> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("extraArgs"), name -> {
        ...
        , (Object[] args) -> new Allocation_ExecuteTransfer(JsonLfDecoders.cast(args[0])));
  }

  public static Allocation_ExecuteTransfer fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Allocation_ExecuteTransfer)) {
      return false;
    }
    Allocation_ExecuteTransfer other = (Allocation_ExecuteTransfer) object;
  ...
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.allocationv1.Allocation_ExecuteTransfer(%s)",
        this.extraArgs);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Allocation_ExecuteTransfer> get() {
      return jsonDecoder();
    }
  }
}
