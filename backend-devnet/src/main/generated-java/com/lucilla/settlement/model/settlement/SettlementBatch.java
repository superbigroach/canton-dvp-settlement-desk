...
public final class SettlementBatch extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#canton-dvp-settlement-desk", "Settlement", "SettlementBatch");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("f10d37a10d40ff7923e1d7476f49347809a28a7803b3be0c4252b2417f921d12", "Settlement", "SettlementBatch");
  ...
  public static final Choice<SettlementBatch, Archive, Unit> CHOICE_Archive = 
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, SettlementBatch> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(SettlementBatch.PACKAGE_ID, SettlementBatch.PACKAGE_NAME, SettlementBatch.PACKAGE_VERSION),
        "com.lucilla.settlement.model.settlement.SettlementBatch", TEMPLATE_ID, ContractId::new,
  ...
  public static class Contract extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, SettlementBatch> {
    public Contract(ContractId id, SettlementBatch data, Set<String> signatories,
