...
public final class SettlementReceipt extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#canton-dvp-settlement-desk", "Settlement", "SettlementReceipt");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("f10d37a10d40ff7923e1d7476f49347809a28a7803b3be0c4252b2417f921d12", "Settlement", "SettlementReceipt");
  ...
  public static final Choice<SettlementReceipt, Archive, Unit> CHOICE_Archive = 
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, SettlementReceipt> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(SettlementReceipt.PACKAGE_ID, SettlementReceipt.PACKAGE_NAME, SettlementReceipt.PACKAGE_VERSION),
        "com.lucilla.settlement.model.settlement.SettlementReceipt", TEMPLATE_ID, ContractId::new,
  ...
  public static JsonLfDecoder<SettlementReceipt> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "venue", "auditor", "assetInstrument", "assetAmount", "cashInstrument", "cashAmount", "unitPrice", "settledAt"), name -> {
          switch (name) {
            ...
            case "venue": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.optional(com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party), java.util.Optional.empty());
  ...
  public static class Contract extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, SettlementReceipt> {
    public Contract(ContractId id, SettlementReceipt data, Set<String> signatories,
