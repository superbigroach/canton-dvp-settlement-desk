...
public class TransferInstruction_Reject extends DamlRecord<TransferInstruction_Reject> {
  ...
  public TransferInstruction_Reject(ExtraArgs extraArgs) {
    this.extraArgs = extraArgs;
  }

  public static ValueDecoder<TransferInstruction_Reject> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new TransferInstruction_Reject(extraArgs);
    } ;
  }
  ...
  public static JsonLfDecoder<TransferInstruction_Reject> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("extraArgs"), name -> {
        ...
        , (Object[] args) -> new TransferInstruction_Reject(JsonLfDecoders.cast(args[0])));
  }

  public static TransferInstruction_Reject fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof TransferInstruction_Reject)) {
      return false;
    }
    TransferInstruction_Reject other = (TransferInstruction_Reject) object;
  ...
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.transferinstructionv1.TransferInstruction_Reject(%s)",
        this.extraArgs);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<TransferInstruction_Reject> get() {
      return jsonDecoder();
    }
  }
}
