...
public class TransferInstruction_Withdraw extends DamlRecord<TransferInstruction_Withdraw> {
  ...
  public TransferInstruction_Withdraw(ExtraArgs extraArgs) {
    this.extraArgs = extraArgs;
  }

  public static ValueDecoder<TransferInstruction_Withdraw> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new TransferInstruction_Withdraw(extraArgs);
    } ;
  }
  ...
  public static JsonLfDecoder<TransferInstruction_Withdraw> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("extraArgs"), name -> {
        ...
        , (Object[] args) -> new TransferInstruction_Withdraw(JsonLfDecoders.cast(args[0])));
  }

  public static TransferInstruction_Withdraw fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof TransferInstruction_Withdraw)) {
      return false;
    }
    TransferInstruction_Withdraw other = (TransferInstruction_Withdraw) object;
  ...
  public String toString() {
    return String.format("com.lucilla.settlement.model.splice.api.token.transferinstructionv1.TransferInstruction_Withdraw(%s)",
        this.extraArgs);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<TransferInstruction_Withdraw> get() {
      return jsonDecoder();
    }
  }
}
