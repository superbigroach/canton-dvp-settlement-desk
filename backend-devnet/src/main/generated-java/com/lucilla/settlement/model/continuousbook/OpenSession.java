...
public class OpenSession extends DamlRecord<OpenSession> {
  public static final String _packageId = "527a2b50430ceabba40484b4518c4d390781e8db6c016ab3ec5528eea36766ea";

  public OpenSession() {
  }

  public static ValueDecoder<OpenSession> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<OpenSession> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new OpenSession());
  }

  public static OpenSession fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof OpenSession)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "com.lucilla.settlement.model.continuousbook.OpenSession";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<OpenSession> get() {
      return jsonDecoder();
    }
  }
}
